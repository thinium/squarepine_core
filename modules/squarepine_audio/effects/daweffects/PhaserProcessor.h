...
namespace djdawprocessor
{
/// there appears to be some feedback/resonance in effect, 3 notches/dips/peaks (need more APFS)
/// wet/dry is true blend, center freq of APFs goes from 400-5K, default time = 2000ms (freq of LFO)
/// X-PAD control adds warble to the modulated delay, see the LFOFilter for a detailed description
